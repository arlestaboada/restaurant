...
export default function Favorites({navigation}) {
  ...
  if(!restaurants){
    ...
    return <Loading isVisible={loading} text="Cargando restaurantes ..."/>
...
function Restaurant({restaurant,setLoading,toastRef,navigation,setReloadData}){
  ...
  return(
    <View style={styles.restaurant}>
      <TouchableOpacity
      onPress={()=>navigation.navigate("restaurants-nav",{
        screen:"restaurant",
        params:{id,name}
  ...
  return(
    <View style={{flex:1,alignItems:"center",justifyContent:"center"}}>
       ...
       <Button
        ...
        onPress={()=>navigation.navigate("account-nav",{screen:"login"})}
